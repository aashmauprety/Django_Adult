...
def contains_abusive(input_text):
    """Checks the input_text for any adult content and returns True if it does.
...
def censor(input_text):
    """ Returns the input string with abusive words replaced with a random string
...
def load_words(wordlist=None):
    """ Loads and caches the abusive word list. Input file (if provided)
